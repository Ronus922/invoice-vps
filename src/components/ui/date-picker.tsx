  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <button
          className={`flex h-10 w-full items-center gap-2 rounded-[10px] border border-[rgba(126,152,210,0.18)] bg-[rgba(126,152,210,0.08)] px-3 py-2 text-[13.5px] transition-all hover:bg-[rgba(126,152,210,0.14)] ${value ? 'text-[#c9d8f2]' : 'text-[#5d729c]'} ${className || ''}`}
          dir="rtl"
        >
